...
const OWNER = 'JaneDoe774';
const REPONAME = 'migration-map';
const BOT_EMAIL = 'info@hau-rock.de';
const BOT_NAME = 'homomigrans-bot';
...
// TO DO: Inhalt in JSON File kopieren
    return await createPullRequest(year, name, tmpDirPath);
  } catch (error) {
    return new Promise((resolve, reject) => {
      reject(error);
    });
